...
const ConfirmRide = (props) => {
    return (
        <div>
            ...
            }} className='bg-green-400 w-full mt-5 text-white font-semibold p-2 rounded-lg'>Confirm</button>
        </div>
    )
}
