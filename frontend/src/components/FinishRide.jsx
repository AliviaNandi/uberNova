    ...
    <div>
            ...
            <div className='flex gap-2 flex-col justify-between items-center'>
                ...
                <div className='mt-10 w-full'>
                        ...
                        <Link to='/captain-home' className='bg-green-400 text-lg flex justify-center w-full mt-5 text-white font-semibold p-3 rounded-lg'>Finish Ride</Link>
                        <p className='mt-10 text-xs'>Click on finish ride button if you have completed payement.</p>
