            ...
            <div className='flex gap-2 flex-col justify-between items-center'>
                ...
                <div className='mt-6 w-full'>
                    <form onSubmit={(e) => {
                        ...
                        <Link to='/captain-riding' className='bg-green-400 flex justify-center w-full mt-5 text-white font-semibold p-3 rounded-lg'>Confirm</Link>
                        <button onClick={() => {
                            props.setConfirmRidePopupPanel(false)
                            props.setRidePopupPanel(false)
                        }} className='bg-red-500 w-full mt-2 text-white font-semibold p-3 rounded-lg'>Cancel</button>
                    </form>
                </div>
            </div>
        </div>
