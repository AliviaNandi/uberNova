...
const CaptainRiding = () => {
  ...
  return (
    <div className='h-screen relative'>
      ...
      <div className='h-1/5 p-6 items-center justify-between relative bg-yellow-400 pt-10'
      onClick={()=>{
      ...
      <h5 className='p-1 text-center w-[95%] absolute top-0' onClick={() => {
        ...
        <button className='bg-green-600 font-semibold p-3 px-10 rounded-lg'>Complete Ride</button>
      </div>
