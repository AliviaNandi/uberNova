...
const Home = () => {
    ...
    return (
        <div className='h-screen relative overflow-hidden'>
            ...
            <div className='flex flex-col justify-end h-screen absolute top-0 w-full'>
                <div className='h-[30%] p-6 bg-white relative'>
                    ...
                    <form onSubmit={(e) => {
                        ...
                        <div className="line absolute h-16 w-1 bg-gray-900 top-[40%] rounded-full left-10"> </div>
                        <input
                            onClick={() => {
                                setPanelOpen(true)
                            }}
            ...
            <div ref={vehiclePanelRef} className='fixed w-full z-10 bottom-0  translate-y-full p-3 py-10 px-3 pt-12 bg-white'>
                <VehiclePanel setConfirmRidePanel={setConfirmRidePanel} setVehiclePanel={setVehiclePanel} />
            </div>
            <div ref={ConfirmRidePanelRef} className='fixed w-full z-10 bottom-0  translate-y-full p-3 py-6 px-3 pt-12 bg-white'>
