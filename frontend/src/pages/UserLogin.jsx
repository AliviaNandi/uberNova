...
const UserLogin = () => {
  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between'>
        ...
        className='bg-[#eeeeee] mb-7 rounded px-4 py-2  w-full text-xl placeholder:text-base'
        type="email" 
      ...
      <p className='text-center'>New Here?<Link to='/signup'className='text-blue-600'>Create new account</Link></p>
        ...
        <div>
            <Link
            to='/captain-login'
            className='bg-[#10b461] flex items-center justify-center text-white font-semibold mb-7 rounded px-4 py-2  w-full text-xl placeholder:text-base'>
